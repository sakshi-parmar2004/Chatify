...
- **Conversations are implicit.** There is no `Conversation` collection. A chat partner is
...
**Status** Phase 1 · ⬜ Open — see [`DEC-04`](#dec-04--rooms-over-application-level-fan-out)
